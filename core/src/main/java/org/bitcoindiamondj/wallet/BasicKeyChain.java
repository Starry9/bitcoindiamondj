...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.bitcoindiamondj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.bitcoindiamondj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
