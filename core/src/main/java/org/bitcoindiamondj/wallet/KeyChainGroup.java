...
public class KeyChainGroup implements KeyBag {
     ...
     * @see org.bitcoindiamondj.wallet.MarriedKeyChain
     */
     ...
     *
     * @throws org.bitcoindiamondj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     *
     * @throws org.bitcoindiamondj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
