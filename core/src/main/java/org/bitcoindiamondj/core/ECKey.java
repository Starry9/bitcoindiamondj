...
public class ECKey implements EncryptableItem {
     ...
     * @throws org.bitcoindiamondj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * @throws org.bitcoindiamondj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
