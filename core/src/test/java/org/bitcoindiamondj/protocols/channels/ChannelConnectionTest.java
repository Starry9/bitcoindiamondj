...
package org.bitcoindiamondj.protocols.channels;

import org.bitcoindiamondj.core.*;
import org.bitcoindiamondj.protocols.channels.PaymentChannelClient.VersionSelector;
import org.bitcoindiamondj.script.ScriptPattern;
import org.bitcoindiamondj.testing.TestWithWallet;
...
import org.bitcoindiamondj.wallet.WalletFiles;
...
import static org.bitcoindiamondj.protocols.channels.PaymentChannelClient.VersionSelector.*;
import static org.bitcoindiamondj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.bitcoindiamondj.testing.FakeTxBuilder.createFakeBlock;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.bitcoindiamondj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
