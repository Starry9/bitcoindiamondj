...
# Change this to point to where you have a copy of the bitcoindiamondj.jar
sys.path.append(r"/path/to/bitcoindiamondj-core-0.12-bundled.jar")
...
if __name__ == "__main__":
    params = org.bitcoindiamondj.params.TestNet3Params.get()
